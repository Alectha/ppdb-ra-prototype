...
<head>
    ...
    <title>Login Admin - RA Almukhtarul Bayyan</title>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">RA Almukhtarul Bayyan</p>
            </div>
            ...
            <div class="text-center mt-4">
                <a href="{{ route('beranda') }}" class="text-sm text-gray-600 hover:text-green-500">

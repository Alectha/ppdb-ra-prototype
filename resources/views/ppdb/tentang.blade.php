        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="desktop-menu hidden md:block">
                <ul class="flex space-x-8">
                    ...
                    <li><a href="/tentang" class="text-green-500 font-medium">Tentang</a></li>
                </ul>
            </nav>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-700">
                            "Membentuk generasi muslim yang berakhlak mulia, cerdas, dan mandiri melalui pendidikan islami yang terpadu"
                        </p>
                    </div>
            ...
            <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
                <div class="grid md:grid-cols-2 gap-8">
                    <div>
                        ...
                        Jl. Kh zabidi Nagarakasih<br>
                        Kel.Kersanagara Kec. Cibeureum<br>
                        Kota Tasikmalaya
                        </p>
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 mb-4">
                            <i class="fas fa-phone-alt mr-2"></i> (021) 12345678
                        </p>
                        <p class="text-gray-700 mb-4">
                            <i class="fas fa-envelope mr-2"></i> info@raalmukhtarulbayyan.sch.id
                        </p>
                        <p class="text-gray-700">
                            <i class="fas fa-globe mr-2"></i> www.raalmukhtarulbayyan.sch.id
                        </p>
                    </div>
                </div>
            </div>
